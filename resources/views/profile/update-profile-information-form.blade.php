<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="form-group">
            ...
            <x-jet-input-error for="first_name" class="mt-2 d-block" />
        </div>
        <div class="form-group">
