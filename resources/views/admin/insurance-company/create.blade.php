...
<x-jet-form-section :buttonGroup="['other' => [['text' => __('labels.exit'), 'url' => routeCheck($route . 'index')]]]"
         class="validationForm" novalidate action="{{ routeCheck($route.'store') }}" method="post" x-data="{ domiciliary: 'no' }">
       @slot('form')
                ...
                <!--<div class="form-group row align-items-center">
                    ...
                    <div class="col-sm-9">
                        <div class="zinput zradio zradio-sm  zinput-inline  p-0">
                            <input id="mailing_address_yes"   @change="domiciliary = 'yes'" name="mailing_address_radio" type="radio" required
                                class="form-check-input" value="yes">
                            <label for="mailing_address_yes" class="form-check-label">@lang("labels.yes")</label>
                        </div>
                        <div class="zinput zradio  zradio-sm   zinput-inline  p-0">
                            <input id="mailing_address_no"  @change="domiciliary = 'no'" name="mailing_address_radio" type="radio" required
              ...
              {{--   <div class="form-group row">
               ...
               {{--  <div class="mb-3">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <x-jet-input type="url"  name="am_best[url]" class="am_best_url" readonly="readonly"/>
                    </div>
                </div>
                 <div class="form-group row">
                        ...
                        <div class="row form-group align-top-radio">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="zinput zradio  zradio-sm   zinput-inline  p-0">
                                    ...
                                    <label for="no" class="form-check-label">Save and Reset existing FINANCE
                                        COMPANIES:
                                        Save the
                                        default coverage types values and apply the default coverage types
                                        values to all existing FINANCE COMPANIES for the coverage types. ALL EXISTING
                                        COVERAGE
