                ...
                <div class="row mb-2 align-items-center ">
                    <div class="col-lg-6">
                        <div class="ui selection dropdown table-head-dropdown">
                            ...
                            <div class="text">Active {{ dynamicPageTitle('page') ?? '' }}</div>
                            <div class="menu">
                                <div class="item" @click="open = 'Action'">Active {{ dynamicPageTitle('page') ?? '' }}</div>
                                <div class="item" @click="open = ''">Suspended {{ dynamicPageTitle('page') ?? '' }}</div>
                                 <div class="item" @click="open = ''">Temporary {{ dynamicPageTitle('page') ?? '' }}</div>
                ...
                <div x-show="open == 'Logs'">
                    ...
                    <div class="table-responsive-sm">
                        <x-bootstrap-table :data="[
                            ...
                            'ajaxUrl' => (Route::has('admin.logs') ? route('admin.logs',['type'=>'finance-company']) : ''),
                           'addUrl' => (Route::has($route.'create') ? route($route.'create') : '')
                           ]">
