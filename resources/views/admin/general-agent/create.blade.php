        ...
        <div class="row justify-content-center" x-data="{ open: 'one' }">
            <div class="col-lg-12">
                ...
                <form class="validationForm" novalidate method="POST"
                    ...
                    <div class="mb-3">
                        <!--p class="fw-500">General Agent Information</p -->&nbsp;
                    </div>
                    ...
                    <div class="tab-one">
                        <div class="form-group row">
                            ...
                            <div class=`"col-sm-9">
                                <input type="text" name="agency_name" class="form-control input-sm" id="agency_name"
                                    placeholder="" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="legal_name" class="col-sm-3 col-form-label ">d/b/a</label>
                            <div class="col-sm-9">
                                <input type="text" name='legal_name' class="form-control input-sm username"
                                    id="legal_name" placeholder=""
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                 {!! form_dropdown('agent_entity_type',['Corporation','Limited Liability Company','Partnership','Sole Proprietor','Other'], [], ["class"=>"ui fluid normal dropdown input-sm"]) !!}
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="fein_ssn" class="col-sm-3 col-form-label ">TIN/FEIN #</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control input-sm tin " name="fein_ssn" id="fein_ssn" placeholder="">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="licence_expiration_date" class="form-control input-sm" id="licence_expiration_date" placeholder="" >
                            </div>
                        </div>
                        <div class="form-group row">
                      ...
                      <div class="row">
                       ...
                       <div class="row">
                            <label for="physical_address" class="col-sm-3 col-form-label">Mailing Address</label>
                            <div class="col-sm-9">
                                <div class="form-group row">
                                    <div class="col-md-12 mb-1">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <?=  form_dropdown('physical_address_state', stateDropDown(), '', ["class"=>"ui dropdown input-sm w-100",'id'=>'primary_address_state']); ?>


                                    </div>
                                    <div class="col-md-2">
                                        <input type="text" class="form-control input-sm zip_mask" id="physical_address_zip"
                                            name="physical_address_zip" placeholder="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!--div class="form-group row align-items-center">
                            <label for="mailing_address_yes" class="col-sm-3 col-form-label requiredAsterisk">Dose Mailing Address The Same as Physical Address?</label>
                            <div class="col-sm-9">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="zinput zradio  zradio-sm   zinput-inline  p-0">
                                            ...
                                            <label for="no" class="form-check-label">Save and Reset existing FINANCE COMPANIES: Save the default
                                                coverage types values and apply the default coverage types
                                                values to all existing FINANCE COMPANIES for the coverage types. ALL EXISTING COVERAGE TYPES AND
