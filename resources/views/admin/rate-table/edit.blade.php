<x-app-layout>
    ...
    <x-jet-form-section :buttonGroup="[
        'logs',
        'other' => [['text' => 'Assign to Agents', 'url' => routeCheck($route . 'assignToAgents', $id)]],
                                    ...
                                    @foreach ($data['rate_table_fee'] as $key => $feeRow)
                                        <tr>
                                            <input type="hidden" name="rateTable[feeId][]"
                                                value="{{ encryptData($feeRow['id']) ?? '' }}">
                                            <td>
                                                <x-jet-checkbox for="fee_amount_row_{{ $loop->iteration }}"
                                                    id="fee_amount_row_{{ $loop->iteration }}" class="fee_amount_row" />
                                            </td>
                                            <td>
                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-sm-7">
                                                        ...
                                                        <x-jet-checkbox for="changesetup_{{ $loop->iteration }}"
                                                            class="changesetup setup_fees" :checked="$feeRow['is_state_maximun'] == 1 ? true : false"
                                                    ...
                                                    <div class="col-sm-4">
                                                        <x-jet-input type="text" class="amount changesetup setup_fee"
                                                            name="rateTable[setup_fee_amount][]" id="changesetup" required
                                    ...
                                    <tr>
                                        ...
                                        <td class="addRateTableSetupfee">
                                            <div class="row align-items-center">
                                                <div class="col-sm-7">
                                                    <label for="">Use State Maximun</label>
                                                    <x-jet-checkbox for="changesetup_1" class="changesetup setup_fees"
