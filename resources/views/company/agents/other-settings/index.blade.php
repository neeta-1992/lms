<form class="validationForm editForm" novalidate action="{{ routeCheck('company.agents.other-settings', $id) }}"
    ...
    <div class="form-group row">
        <label for="down_payment_increase" class="col-sm-3 col-form-label ingnorTitleCase">@lang('labels.down_paymen_percent_increase')</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        <label for="loan_origination_state" class="col-sm-3 col-form-label ">@lang('labels.default_loan_origination_state')</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            ...
            @endphp
            {!! form_dropdown('program[]', stateProgramSetting(), $program, [
    ...
    <div class="form-group row">
        <label for="state" class="col-sm-3 col-form-label ">@lang('labels.down_payment_rule_for_original_quoting')</label>
        <div class="col-sm-9">

            {!! form_dropdown(
                'down_payment_rule_original_quoting',
                downPaymentDropDown(),
                $data['down_payment_rule_original_quoting'] ?? '',
                ['class' => 'w-100'],
            ) !!}
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="down_payment_rule_ap_quoting" class="col-sm-3 col-form-label ">@lang('labels.down_payment_rule_for_ap_quoting')</label>
        <div class="col-sm-9">
            {!! form_dropdown(
                'down_payment_rule_ap_quoting',
                downPaymentDropDown(),
                $data['down_payment_rule_ap_quoting'] ?? '',
                ['class' => 'w-100'],
            ) !!}
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="name" class="col-sm-3 col-form-label ">@lang('labels.restrict_pfa_printing_below_this_amount_financed')</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        <label for="name" class="col-sm-3 col-form-label ">@lang('labels.restrict_pfa_printing_above_this_amount_financed')</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            {!! form_dropdown('quote_point', agentUsers(['agencyId' => $id]), $data['quote_point'] ?? '', [
                'class' => 'w-100',
            ]) !!}
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="state" class="col-sm-3 col-form-label ">@lang('labels.accounts_point_of_responsibility_user')</label>
        <div class="col-sm-9">
            {!! form_dropdown('account_point', agentUsers(['agencyId' => $id]), $data['account_point'] ?? '', [
                'class' => 'w-100',
            ]) !!}
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="state" class="col-sm-3 col-form-label ">@lang('labels.marketing_point_of_responsibility_user')</label>
        <div class="col-sm-9">
            {!! form_dropdown('marketing_point', agentUsers(['agencyId' => $id]), $data['marketing_point'] ?? '', [
                'class' => 'w-100',
            ]) !!}
        </div>
    </div>
    ...
    <div class="form-group row">
        <label for="default_email_subject" class="col-sm-3 col-form-label ">@lang('labels.default_email_subject')</label>
        <div class="col-sm-9">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <textarea name="default_email_message" id='default_email_message' cols="30" class="form-control" rows="3"></textarea>
        </div>
    </div>
    <div class="form-group row">
        <label for="name" class="col-sm-3 col-form-label ">@lang('labels.make_email_message_read_only_so_the_default_must_be_used')</label>
        <div class="col-sm-9">
            <x-jet-checkbox for="email_message_read_only" name="email_message_read_only" id="email_message_read_only"
                value="email_message_read_only" />

        </div>
    </div>

    <div class="form-group row">
        <label for="name" class="col-sm-3 col-form-label ">@lang('labels.make_email_subject_read_only_so_the_default_must_be_used')</label>
        <div class="col-sm-9">
            <x-jet-checkbox for="email_subject_read_only" name="email_subject_read_only" id="email_subject_read_only"
                value="email_subject_read_only" />
