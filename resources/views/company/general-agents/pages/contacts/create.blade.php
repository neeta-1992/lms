 <form class="contactForm" novalidate action="{{ routeCheck('company.general-agents-contact.store') }}" method="post">
     ...
     <div class="form-group row">
      ...
      <div class="form-group row">
         ...
         <div class="col-sm-9">
             ...
             <x-jet-input type="text" name="fax" class="fax"  class="w-50" />
         </div>
     </div>
      <div class="form-group row">
