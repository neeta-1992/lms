                            ...
                            <div class="columns">
                                <div class="ui selection dropdown table-head-dropdown">
                                    ...
                                    <div class="menu">
                                        ...
                                        <div class="item" @click="open = 'quotes'" x-show="open != 'quotes'">@lang('labels.quote')
                                        </div>
                ...
                <div class="col-md-12" x-show="open == 'general-information'">
                    <form class="validationForm editForm" novalidate method="POST"
                        ...
                        <div class="form-group row">
                           ...
                           @lang('labels.general_agency_name') </label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-sm-3 col-form-label "> 
                                 @lang('labels.maximum_reinstate_allowed')</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="notes" class="col-sm-3 col-form-label ">@lang('labels.notes') Notes</label>
                            <div class="col-sm-9">
