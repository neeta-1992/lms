                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @if($noticesDescriptionText)
                                    ...
                                    @endphp
                                           <tr>
                                                <td><a href="javascript:void(0)" class="noticeTemplateShow" data-url="{{ routeCheck('ajax.notice-template-data',['type'=>'insured','action'=>($key ??  "")]) }}" data-notice-type="{{ $sendType ?? '' }}" >{{ $row ?? '' }}</a></td>
                                                <td>
