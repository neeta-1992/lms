<x-app-layout :class="['datepicker']">
    <section class="font-1 pt-5 hq-full" x-data="{ open: 'general-information', title: 'General Information', backPage: '', usersEditUrl: null }"
        x-effect="async () => {
                    ...
                    <form class="validationForm editForm" novalidate method="POST"
                        ...
                        <div class="col-sm-9">
                            <div class="zinput zradio zradio-sm  zinput-inline">
                                <input id="decline_reinstatement_enable" name="insurance[decline_reinstatement]" type="radio"
                            ...
                            <div class="zinput zradio  zradio-sm   zinput-inline">
                                <input id="decline_reinstatement_disable" name="insurance[decline_reinstatement]" type="radio"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                  <x-jet-input type="text" name="insurance[years_business]" class="digitLimit w-25" data-limit="2" />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                  <x-jet-input type="text" name="insurance[naics_code]" class=" w-25"  />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                  <x-jet-input type="text" name="insurance[duns]" class=" w-25"  />
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                  <x-jet-input type="text" name="insurance[dbconfidence_code]" class=" w-25"  />
