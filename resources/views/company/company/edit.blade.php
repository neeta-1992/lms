<x-app-layout>
    @can("isAdminCompany")
    @php
    $buttonArr = ['text'=>__('Deactivate'),'class'=>'deactiveCompany','dataId'=>encryptUrl($data['id'])]
    @endphp
    @endcan
    <x-jet-form-section :buttonGroup="['other' => [($buttonArr ?? []),['text' => __('labels.cancel'), 'url' => routeCheck('company.dashboard')]]]" class="validationForm editForm" novalidate action="{{ routeCheck($route.'update',$id) }}" method="post" x-effect="async () => {
            switch (open) {
                case 'isForm':
        ...
        <div class="columns">
            <div class="ui selection dropdown table-head-dropdown">
                ...
                <div class="menu">
                    <div class="item" @click="open = 'isForm'" x-show="open !== 'isForm'">@lang('labels.general_information')</div>
                    <div class="item" @click="open = 'special-permission'" x-show="open !== 'special-permission'">@lang('labels.special_permission')  </div>
        ...
        <div class="form-group row">
            <label for="comp_domain_name" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.domain_name')
                </label>
            <div class="col-sm-9">
                <input type="text" readonly name='comp_domain_name' class="form-control input-sm username" id="comp_domain_name" placeholder="" oninput="this.value = this.value.toLowerCase()" required>
            </div>
        </div>
        <div class="form-group row">
            <label for="comp_web_address" class="col-sm-3 col-form-label ">@lang('labels.web_url') </label>
            <div class="col-sm-9">
                <input type="email" name="comp_web_address" class="form-control input-sm" id="comp_web_address" placeholder="www.domain.com">
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="form-group row">
                    <label for="comp_nav_back_color_hex" class="col-sm-2 col-form-label">@lang('labels.hex') </label>
                    <div class="col-sm-5">
                        <input type="text" name="comp_nav_back_color_hex" class="form-control input-sm" id="comp_nav_back_color_hex" placeholder="">
                    </div>
                    <div class="col-sm-3">
                        <div class="row">
                            <label for="comp_nav_back_color_rbg" class="col-sm-6 col-form-label">@lang('labesl.rgb') </label>
                            <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="form-group row">
                    <label for="comp_nav_text_color_hex" class="col-sm-2 col-form-label">@lang('labels.hex') </label>
                    <div class="col-sm-5">
                    ...
                    <div class="col-sm-3">
                        <div class="row">
                            <label for="comp_nav_text_color_rbg" class="col-sm-6 col-form-label">@lang('labels.rgb')</label>
                            <div class="col-sm-6">
        ...
        <div class="row">
            <label for="comp_nav_hover_color_hex" class="col-sm-3 col-form-label">@lang('labels.navigation_text_hover_color')
                </label>
            <div class="col-sm-9">
                <div class="form-group row">

                    <label for="comp_nav_hover_color_hex" class="col-sm-2 col-form-label">@lang('labels.hex') </label>
                    <div class="col-sm-5">
                        <input type="text" name="comp_nav_hover_color_hex" class="form-control input-sm" id="comp_nav_hover_color_hex" placeholder="">
                    </div>
                    <div class="col-sm-3">
                        <div class="row">
                            <label for="comp_nav_hover_color_rbg" class="col-sm-6 col-form-label">@lang('labels.rgb')</label>
                            <div class="col-sm-6">
        ...
        <div class="row">
            <label for="primary_address" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.company_primary_address')
                </label>
            <div class="col-sm-9">
                <div class="form-group row">
        ...
        <div class="form-group row">
            <label for="primary_telephone" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.primary_telephone')
                </label>
            <div class="col-sm-4">
        ...
        <div class="row">
            <label for="payment_coupons_address" class="col-sm-3 col-form-label">@lang('labels.coupons_invoices_statement_address')
                </label>
            <div class="col-sm-9">
                <div class="form-group row">
                    <div class="col-md-12 mb-1">
        ...
        <div class="form-group row">
            <label for="comp_contact_name" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.company_contact_name')
               </label>
            <div class="col-sm-9">
        ...
        <div class="form-group row">
            <label for="comp_contact_email" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.company_contact_email')
             </label>
            <div class="col-sm-9">
        ...
        <div class="form-group row">
            <label for="stateLicensed" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.us_time_zone')
                </label>
            <div class="col-sm-4">
                <?=  form_dropdown('us_time_zone', timeZoneDropDown(), '', ["class"=>"ui dropdown input-sm w-100","required"=>true]); ?>
            </div>
        </div>
        <div>
        ...
        <div class="row">
            <label for="administrator_email" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.administrator_email')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="administrator_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="administrator_email_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')  </label>
                            <div class="col-sm-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="zinput zradio zradio-sm  zinput-inline p-0">
                                    ...
                                    <label for="administrator_email_authentication_yes" class="form-check-label">@lang('labels.yes') </label>
                                </div>
                                <div class="zinput zradio  zradio-sm   zinput-inline  p-0">
                                    ...
                                    <label for="administrator_email_authentication_no" class="form-check-label">@lang('labels.no') </label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="administrator_email_username" class="col-sm-12 col-form-label">@lang('labels.username') </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="administrator_email_passward" class="col-sm-12 col-form-label">@lang('labels.password') </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <div class="col-sm-12">
                                <label for="" class="col-sm-12 col-form-label" style="opacity:0;">a</label>
                            </div>
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.quote_activation_email')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="quote_activation_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="quote_activation_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="zinput zradio zradio-sm  zinput-inline p-0">
                                    ...
                                    <label for="quote_activation_authentication_yes" class="form-check-label">@lang('labels.yes') </label>
                                </div>
                                <div class="zinput zradio  zradio-sm   zinput-inline  p-0">
                                    ...
                                    <label for="quote_activation_authentication_no" class="form-check-label">@lang('labels.no') </label>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.esignature_email')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="esignature_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="esignature_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control input-sm" name="email_setting[esignature][password]" id="esignature_passward">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.from_system_email')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="from_system_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="from_system_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control input-sm" name="email_setting[from_system][password]" id="from_system_passward">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.reply_to_email')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="reply_to_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="reply_to_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control input-sm" name="email_setting[reply_to][password]" id="reply_to_passward">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.notices_email')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="notices_email_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="notices_email_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="zinput zradio zradio-sm  zinput-inline p-0">
                                    ...
                                    <label for="notices_email_authentication_yes" class="form-check-label">@lang('labels.yes') </label>
                                </div>
                                <div class="zinput zradio  zradio-sm   zinput-inline  p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control input-sm" name="email_setting[notices][password]" id="notices_email_passward">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.tasks_email')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="tasks_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="tasks_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.attachments_email')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="attachments_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="attachments_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control input-sm" name="email_setting[attachments][password]" id="attachments_passward">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.messages_email')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="messages_email_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="messages_email_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="zinput zradio zradio-sm  zinput-inline p-0">
                                    ...
                                    <label for="messages_email_authentication_yes" class="form-check-label">@lang('labels.yes') </label>
                                </div>
                                <div class="zinput zradio  zradio-sm   zinput-inline  p-0">
                                    ...
                                    <label for="messages_email_authentication_no" class="form-check-label">@lang('labels.no') </label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control input-sm" name="email_setting[messages][password]" id="messages_email_passward">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.sales_organization')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="sales_email_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="sales_email_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control input-sm" name="email_setting[sales][password]" id="sales_email_passward">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="row">
            <label for="officelocation" class="col-sm-3 col-form-label  requiredAsterisk">@lang('labels.email_2_fax')
                </label>
            <div class="col-sm-9">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="faxl_email" class="col-sm-12 col-form-label">@lang('labels.email_address')
                                </label>
                            <div class="col-sm-12">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="faxl_outgoing_server" class="col-sm-12 col-form-label">@lang('labels.outgoing_server')
                                </label>
                            <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control input-sm" name="email_setting[fax][password]" id="faxl_passward">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
        ...
        <div class="form-group row align-items-center">
            <label for="" class="col-sm-3 col-form-label requiredAsterisk">@lang('labels.prepend_a_1_on_to_outgoing_faxs')
                </label>
            <div class="col-sm-9">
        ...
        <div x-data="{showFax:'{{ !empty($data['use_subject']) ?  ($data['use_subject'] == 'Yes' ? 'yes' : 'no') : '' }}',isDislable: '{{ (!empty($data['use_security_code']) && $data['use_security_code'] == 'no') ? false : true }}'}">
            <div class="form-group row align-items-center">
                ...
                <div class="col-sm-9">
                    <div class="zinput zradio zradio-sm  zinput-inline">
                        ...
                        <label for="use_subject_yes" class="form-check-label">@lang('labels.yes') </label>
                    </div>
                    <div class="zinput zradio  zradio-sm   zinput-inline">
                        ...
                        <label for="use_subject_no" class="form-check-label">@lang('labels.no') </label>
                    </div>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row align-items-center" x-show="showFax == 'yes' || isEmptyChack(showFax)">
                ...
                <div class="col-sm-9">
                    <div class="zinput zradio zradio-sm  zinput-inline">
                        ...
                        <label for="use_security_code_yes" class="form-check-label">@lang('labels.yes') </label>
                    </div>
                    <div class="zinput zradio  zradio-sm   zinput-inline">
                        ...
                        <label for="use_security_code_no" class="form-check-label">@lang('labels.no') </label>
                    </div>
                </div>
            </div>
        ...
        @endslot
        @slot('otherTab')
        <x-form class="validationForm editForm" novalidate action="{{ routeCheck($route.'update',$id) }}" method="post" x-show="(open == 'special-permission')">
            <input type="hidden" name="logsArr">
            @method('put')
            <div class="form-group row">
                <label for="final_approval_enable" class="col-sm-3 col-form-label requiredAsterisk">@lang("labels.quote_final_approval_status")</label>
                <div class="col-sm-9">
                    <x-input-radio inline label="{{ __('labels.enable') }}" id="final_approval_enable" name="final_approval" value="true" required />
                    <x-input-radio inline label="{{ __('labels.disable') }}" id="final_approval_disable" name="final_approval" value="false" required />
                </div>
            </div>
            <div class="form-group row">
                <label for="final_approval_enable" class="col-sm-3 col-form-label requiredAsterisk">@lang("labels.quote_final_assigned_users")</label>
                <div class="col-sm-9">
                    <x-select :options="($userDataOptions ?? [])" name="final_approval_users" class="ui dropdown multiple" multiple required />
                </div>
            </div>
    ...
    <script>
        @if(!empty($model))
        confirmationModel(`Are you sure for  deactivate a finance company`, {
            id: '{{ $id ?? '
            ' }}'
            , class: "deactivefinancecompany"
            , cancelUrl: "{{ routeCheck('company.finance-company.index') }}"
        , });
        @endif
