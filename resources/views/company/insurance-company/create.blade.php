<x-app-layout :class="['datepicker']">
    <x-jet-form-section :buttonGroup="['other' => [['text' => __('text.exit'), 'url' => routeCheck($route . 'index')]]]" class="validationForm" novalidate action="{{ routeCheck($route . 'store') }}"
        ...
        @slot('form')
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <x-jet-input type="text" disabled class="w-25 amount" name="current_aggregate_outstandings"
                        placeholder="$" />
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                    <x-jet-input type="text" class="w-25 amount" name="aggregate_limit" placeholder="$" />
                </div>
            </div>
