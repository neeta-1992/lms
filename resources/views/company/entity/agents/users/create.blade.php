        ...
        <div class="col-sm-9">
            <div class="zinput zradio zradio-sm  zinput-inline">
                <input id="esignature_enable" name="esignature" type="radio"
                    required class="form-check-input" value="allowed">
            ...
            <div class="zinput zradio  zradio-sm   zinput-inline">
                <input id="esignature_disable" name="esignature" type="radio"
                    required class="form-check-input" value="prohibited">
    ...
    <label for="owner" class="col-sm-3 col-form-label ">@lang("labels.owner")</label>
     ...
     <div class="form-group row align-items-center">
        ...
        <div class="col-sm-9">
            ...
            <div class="zinput zradio  zradio-sm   zinput-inline">
                <input id="convicted_disable" name="convicted" type="radio"
        ...
        <div class="col-sm-9">
            <div class="zinput zradio zradio-sm  zinput-inline">
                <input id="reset_password_enable" name="reset_password" type="radio"
                    required class="form-check-input" value="email"
            ...
            <div class="zinput zradio  zradio-sm   zinput-inline">
                <input id="reset_password_disable" name="reset_password" type="radio"
                    required class="form-check-input" value="manually"
     ...
     <div class="form-group row" x-show='resetPassword == "manually"'>
        ...
        <div class="col-sm-9">
            <x-jet-input type="password" name="password" placeholder="Password"  x-bind:required="(resetPassword == 'manually') && 'required'"/>
        </div>
    </div>
     <div class="form-group row" x-show='resetPassword == "email"'>
        ...
        <div class="col-sm-9">
            <x-jet-input type="email" name="reset_password_email" placeholder="Email"  x-bind:required="(resetPassword == 'email') && 'required'"/>
        </div>
    </div>
