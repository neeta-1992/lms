<x-app-layout :class="['datepicker']">
    <section class="font-1 pt-5 hq-full" x-data="{ open: 'general-information', title: 'General Information', officeEditUrl: null, backPage: '', usersEditUrl: null,attachmentsEditUrl:null }" x-effect="async () => {
            ...
            switch (open) {
                ...
                case 'userForm':
                    ...
                    singleDatePicker();
                    percentageInput();
                    $('.office_select select').trigger('change');
                    break;
                case 'attachments':
                    title = 'Attachments'
            ...
            <div class="row">
                ...
                <div class="col-md-12 page_table_menu">
                    <div class="row ">
                        <div class="col-md-4">
                            <div class="columns">
                                <div class="ui selection dropdown table-head-dropdown">
                                    ...
                                    <div class="menu">
                                        <div class="item" @click="open = 'general-information'" x-show="open != 'general-information'">
                                        ...
                                        <div class="item" @click="open = 'other-settings'" x-show="open != 'other-settings'">@lang('labels.other')
                                            settings</div>
                        ...
                        <div class="col-md-8" x-show="(open != 'offices' && open != 'users' && open != 'logs' && open != 'attachments')">
                ...
                <div class="col-md-12" x-show="open == 'general-information'">
                    <form class="validationForm editForm singleForm" novalidate method="POST" action="{{ Route::has($route . 'update') ? route($route . 'update', $id) : '' }}">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group row">
                            <label for="aggregate_limit" class="col-sm-3 col-form-label">@lang('labels.aggregate_limit')</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <x-jet-input type="text" name="licence_expiration_date" class="singleDatePicker" placeholder="mm/dd/yyyy" />
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-6">
                                <div class="d-flex flex-wrap upload_image_box">
                                    ...
                                    <div class="view_files_button">
                                        <a href="javascript:void(0)" onClick="fileIframeModel('{{ $data['upload_agency_ec_insurance_url'] }}')">View
                                            File</a>
                                    </div>
                                    @endif
                                </div>
                ...
                <div class="col-md-12" x-show="open == 'rate-table'">
                    <form class="validationForm editForm" novalidate method="POST" action="{{ Route::has($route . 'update') ? route($route . 'update', $id) : '' }}">
                        @csrf
                        @method('put')
                        <input type="hidden" name="logsArr">
                        <div class="form-group row">
