 <form class="validationForm editForm" novalidate action="{{ routeCheck($route . 'funding.save') }}" method="post"
         ...
         <div class="form-group row">
             ...
             <div class="col-sm-9">
                 <x-jet-input type="text" name="financial_institution_name"
                     value="{{ $data['financial_institution_name'] ?? '' }}" />
             </div>
         </div>
         <div class="form-group row">
     ...
     <div class="form-group row ">
         ...
         <div class="col-sm-9">
             <div class="zinput zradio zradio-sm pb-0">
                 <input id="compensation_Remittance_schedule_option_Days_After"
                     name="compensation_remittance_schedule" type="radio" required class="form-check-input"
                     @checked(($data['compensation_remittance_schedule'] ?? '') == 'Days After Policy Inception') value="Days After Policy Inception">
     ...
     <div class="form-group row">
         ...
         <div class="col-sm-9">
             <x-jet-checkbox for="uneamed_compensation" labelText='' class="" name="uneamed_compensation"
                 ...
                 {{ ($data['uneamed_compensation'] ?? '') == 'uneamed_compensation_on_close' ? 'checked' : '' }} />
         </div>
     </div>
     <div class="form-group row">
     ...
     <div class="form-group row">
         ...
         <div class="col-sm-9">
             <x-jet-checkbox for="hold_all_payables" labelText='' class="changesetup setup_fees"
                 name="hold_all_payables" id="hold_all_payables" value="true"
                 {{ ($data['hold_all_payables'] ?? '') == true ? 'checked' : '' }} />
