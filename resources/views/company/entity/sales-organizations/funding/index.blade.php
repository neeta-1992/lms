...
@csrf
            ...
            <div class="row" x-show="FundingAddress == false">
                <label for="primary_address" class="col-sm-3 col-form-label " style="opacity: 0">Funding Address</label>
                <div class="col-sm-9">
                    <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-9">
                     <x-jet-checkbox for="hold_all_payables"
                        ...
                        id="hold_all_payables" value="true"  :checked="(($data['hold_all_payables'] ?? '') == true ? true : false )"/>
