 <form class="validationForm editForm" novalidate action="{{ routeCheck($route . 'funding.save') }}" method="post"
         ...
         <div class="col-sm-9">
             <div class="zinput zradio zradio-sm pb-0">
                 ...
                 <label for="Remittance_schedule_option_Days_After"
                     ...
                     <x-jet-input type="text" name="days_after_policy_inception_text" style="width: 10% !important;"
                         :value="$data['days_after_policy_inception_text'] ?? ''" />
     ...
     <div class="form-group row ">
         ...
         <div class="col-sm-9">
             <div class="zinput zradio zradio-sm pb-0">
                 <input id="compensation_Remittance_schedule_option_Days_After" name="compensation_remittance_schedule"
                     type="radio" required class="form-check-input" @checked(($data['compensation_remittance_schedule'] ?? '') == 'Days After Policy Inception')
                     value="Days After Policy Inception">
             ...
             <div class="zinput zradio  zradio-sm pb-0">
                 <input id="compensation_Remittance_schedule_option_Month" name="compensation_remittance_schedule"
                     type="radio" required class="form-check-input" @checked(($data['compensation_remittance_schedule'] ?? '') == '15 Days After the End of The Month of Policy Inception')
                     value="15 Days After the End of The Month of Policy Inception">
             ...
             <div class="zinput zradio zradio-sm pb-0">
                 <input id="compensation_Remittance_schedule_option_Policy" name="compensation_remittance_schedule"
                     type="radio" required class="form-check-input" @checked(($data['compensation_remittance_schedule'] ?? '') == 'Days After 1st Payment Due Date')
                     value="Days After 1st Payment Due Date">
     ...
     <div class="form-group row">
         ...
         <div class="col-sm-9">
             <x-jet-checkbox for="uneamed_compensation" labelText='' class="" name="uneamed_compensation"
                 id="uneamed_compensation" value="uneamed_compensation_on_close" :checked="($data['uneamed_compensation'] ?? '') == 'uneamed_compensation_on_close' ? true : false" />
         </div>
     </div>
     <div class="form-group row">
     ...
     <div class="row" x-show="FundingAddress == false">
         <label for="primary_address" class="col-sm-3 col-form-label " style="opacity: 0">@lang('labels.funding_address')</label>
         <div class="col-sm-9">
             <div class="form-group row">
     ...
     <div class="form-group row">
         ...
         <div class="col-sm-9">
             <x-jet-checkbox for="hold_all_payables" labelText='' class="changesetup setup_fees"
                 name="hold_all_payables" id="hold_all_payables" value="true" :checked="($data['hold_all_payables'] ?? '') == true ? true : false" />
