            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-12">
                            <x-jet-input type="text" name="email_information[server]"  value="{{ $email_information['server'] ?? '' }}"/>
                        ...
                        <div class="col-sm-12">
                            <div class="zinput zradio zradio-sm  zinput-inline p-0">
                                <input id="quote_activation_authentication_yes" class="form-check-input"
                                    name="email_information[authentication]" type="radio" value="yes" @checked((!empty($email_information['authentication']) && $email_information['authentication'] == 'yes'))>
                            ...
                            <div class="zinput zradio  zradio-sm   zinput-inline  p-0">
                                <input id="quote_activation_authentication_no" class="form-check-input"
                                    name="email_information[authentication]" type="radio" value="no" @checked((!empty($email_information['authentication']) && $email_information['authentication'] == 'no'))>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-12">
                            <x-jet-input type="text" name="email_information[username]" value="{{ $email_information['username'] ?? '' }}"/>
                ...
                <div class="col-sm-6">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-12">
                            <x-jet-input type="password" name="email_information[password]" value="{{ $email_information['password'] ?? '' }}"/>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12">
                    <div class="row form-group">
                        ...
                        <div class="col-sm-4">
                            {!! form_dropdown('email_information[encryption]', encryptionTypeDropDown(), ($email_information['encryption'] ?? ''), [
                                'class' => 'form-control input-sm',
                            ]) !!}
                        </div>
                    </div>
