                ...
                <tr class="isTitleHeading">
                    ...
                    <td class="vertical-middle">
                        @foreach ($weekArray as $weekKey => $week)
                            ...
                            @endphp
                            <x-jet-checkbox for="unearned_premium_statement_frequency{{ $week }}"
                                labelText='{{ $week }}' class="changesetup setup_fees"
                                name="unearned_premium[frequency][]"
                                id="unearned_premium_statement_frequency{{ $week }}" value="{{ $week }}"
                                :checked="$checked" />
                        @endforeach
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="w-5 ml-3">
                                <div class="form-group mb-0">
                                    {!! form_dropdown(
                                        'unearned_premium[cancel_days]',
                                        range(1, 30),
                                        $data['unearned_premium']['cancel_days'] ?? '',
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="w-5 ml-3  mb-0">
                                <div class="form-group">
                                    {!! form_dropdown(
                                        'notice_of_cancelled[cancel_days]',
                                        range(1, 30),
                                        $data['notice_of_cancelled']['cancel_days'] ?? '',
                                        ['class' => 'min-w-100'],
                                        true,
                                    ) !!}
                                </div>
