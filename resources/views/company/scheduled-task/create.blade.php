<x-app-layout :class="['datepicker','timepicker']">
    <x-jet-form-section :buttonGroup="['exit']" class="validationForm" novalidate action="{{ routeCheck($route . 'store') }}"
        ...
        @slot('form')
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    {!! form_dropdown('task_name', taskName(), '', ["class"=>"ui dropdown input-sm
                    w-100","required"=>null]) !!}
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <x-jet-input type="text"  class="timepicker" name="start_time" id="start_time" required />
                </div>
            </div>
            <div class="form-group row">
