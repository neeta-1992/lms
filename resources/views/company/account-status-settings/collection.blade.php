<div class="row"  x-data="{accountDay:'{{ $data['sending_cancel_days_collection'] ?? '' }}'}">
					 ...
					 <table id="collection"
                      ...
                      class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								<td class=" center">Each account in cancel 2 status will be processed as shown below during 'Update account status' processing.</td>
							</tr>
							<tr>
								<td class=""><div class="arrowiconstext"><i class="fa-2x fa-solid fa-arrow-down arrowicons"></i></div></td>
							</tr>
							<tr>
								<td class="center text-dark bg-light font-weight-bold">Is collection enabled and have more than <span x-text="accountDay" class="sending_cancel_days_collection"></span> days of elapsed?</td>
							</tr>
							<tr>
								<td class="">Have more than
                                    <x-jet-input name="sending_cancel_days_collection" type="text" class="digitLimit d-inline fw-600"
                                 data-limit="2" @input.debounce.100ms="accountDay = $event.target.value" maxlength="2"
                                 style="width:50px;" value="{{ $data['sending_cancel_days_collection'] ?? '' }}" /> days elapsed since sending the cancel 2 notice (setting applies to all states; a value of 0 disables collection)<ul style="list-style-type:none;" class="mb-0">
								<li>AND is automatic update to collection status enabled</li>
							...
							<tr>
								<td class="center text-dark bg-light font-weight-bold">Move to 'Collection' status</td>
							</tr>
							<tr>
								<td class="">Generate collection notice</td>
							</tr>
							<tr>
								<td class=""><div class="arrowiconstext"><i class="fa-2x fa-solid fa-arrow-down arrowicons"></i></div></td>
							</tr>
							...
							<tr>
								<td class="center">The account is now in 'Collection' status. </td>
							</tr>
							<tr>
                         <td>
			...
			<div class="col-lg-4 col-md-4 col-xs-12 js-content Account_Status_Settings_second_table">
				<div class="docs-table nothover Account_Status_Settings">
					 ...
					 <table style="margin-top: 110px;" id="collection22"
					   data-toggle="table" data-buttons-class="default borderless"
                       class="table table-bordered table-hover">
						<thead>
							<tr class="d-none">
						...
						<tbody>
							...
							<tr>
								<td class="">The account remains in 'cancel 2' status.</td>
							</tr>
						</tbody>
					</table>
				</div>
