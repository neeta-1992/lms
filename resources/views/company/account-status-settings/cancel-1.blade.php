 <div class="row" x-data="{accountDay:'{{ $data['cancellation_notice_days'] ?? '' }}'}">
					 ...
					 <table id="Cancel1"
                      ...
                      class="table table-bordered table-hover">
						...
						<tbody>
							...
							<tr>
								<td class="">Have more than <x-jet-input name="cancellation_notice_days"  type="text" class="digitLimit d-inline fw-600"
                                 data-limit="2" @input.debounce.100ms="accountDay = $event.target.value" maxlength="2"
                                 style="width:50px;" value="{{ $data['cancellation_notice_days'] ?? '' }}"  />days elapsed since sending the cancellation notice (setting applies to all states; a value of 0 disables cancellation followup)<ul style="list-style-type:none;" class="mb-0"><li> AND is account in cancel(i.e. not cancel followup) status</li>
							...
							<tr>
								<td class="">Do all policies have a cancellation return premium applied <ul style="list-style-type:none;" class="mb-0"><li>AND is automatic update to cancel 1 status enabled</li><li>AND is there a positive balance due (including fee receipts and fee receivables) </li><li>AND is the account active (not suspended)?</li></ul></td>
							</tr>
							<tr>
								<td class=""><div class="w-100 clearfix">
			...
			<div class="col-lg-4 col-md-4 col-xs-12 js-content Account_Status_Settings_second_table">
				<div class="docs-table nothover Account_Status_Settings">
					 ...
					 <table style="margin-top: 60px;" id="Cancel12"
					   data-toggle="table" data-buttons-class="default borderless"
                      class="table table-bordered table-hover"
