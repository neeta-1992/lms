<x-app-layout>
    <x-jet-form-section :buttonGroup="['logs','other' => [['text' => __('labels.cancel'), 'url' => routeCheck($route . 'index') ]]]" class="validationForm editForm" novalidate action="{{ routeCheck($route . 'update', $id) }}"
        ...
        <input type="hidden" name="logsArr">
            ...
            <div class="form-group row">
                <label for="bank_name" class="col-sm-3 col-form-label requiredAsterisk">Bank name</label>
                <div class="col-sm-9">
                    <x-jet-input type="text" name="bank_name" required />
                </div>
            </div>
            <div class="form-group row">
                <label for="account_number" class="col-sm-3 col-form-label requiredAsterisk">Account number</label>
                <div class="col-sm-9">
            ...
            <div class="form-group row">
                <label for="gl_account" class="col-sm-3 col-form-label requiredAsterisk">GL account #</label>
               <div class="col-sm-9">
