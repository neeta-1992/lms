...
<div class="col-md-12 page_table_menu quotes_in_mail_box_">
            ...
            <div class="row align-items-end">
                <div class="col-md-12">
                    <div class="columns d-flex justify-content-end">
                        <button class="btn btn-default" type="button" x-on:click="accountNotes('{{ $id }}')">
    ...
    <x-table id="{{ $activePage ?? '' }}-notes-append-list" ajaxUrl="{{ routeCheck($route.'note-list',['accountId'=>$typeId,'parentId'=>(!empty($data->parent_id) ? $data->parent_id : $data->id)]) }}">
        <thead>
            <tr>
