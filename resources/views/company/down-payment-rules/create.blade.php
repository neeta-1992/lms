<x-app-layout>
    <x-jet-form-section :buttonGroup="['other' => [['text' => __('labels.exit'), 'url' => routeCheck($route . 'index')]]]" class="validationForm downpaymentruleaddform" novalidate action="{{ routeCheck($route . 'store') }}"
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <x-jet-input type="text" class="digitLimit" maxlength="2" name="monthly_minimum_installment"
                                required />
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <x-jet-input type="text" class="digitLimit" maxlength="2" name="monthly_deafult_installment"
                                required />
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <x-jet-input type="text" class="digitLimit" maxlength="2" name="monthly_maximum_installment"
                                required />
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <x-jet-input type="text" class="digitLimit" maxlength="2"
                                name="quarterly_minimum_installment" required />
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <x-jet-input type="text" class="digitLimit" maxlength="2"
                                name="quarterly_deafult_installment" required />
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <x-jet-input type="text" class="digitLimit" maxlength="2"
                                name="quarterly_maximum_installment" required />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <x-jet-input type="text" class="digitLimit" maxlength="2"
                                name="annually_minimum_installment" required />
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <x-jet-input type="text" class="digitLimit" maxlength="2"
                                name="annually_deafult_installment" required />
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <x-jet-input type="text" class="digitLimit" maxlength="2"
                                name="annually_maximum_installment" required />
                        </div>
                    </div>
                </div>
            </div>
...
<div class="text-left" id="noticemodalError" data-remodal-id="modal"
