 <form class="validationForm" novalidate method="POST" action="{{ routeCheck($route . 'store',['quoteId'=>$quotesId,'versionId'=>$versionId]) }}">
       @csrf
      ...
      <div class="tab-one">
         ...
         <div class="form-group row">
          ...
          <div class="form-group row ">
                ...
                <div class="col-sm-9 ">
                    <x-input-file label="Max file size allowed is 8 MB and Accepted file types are pdf" name="attachments" data-file="attachments" accept=".pdf" required  multiple />
                </div>
            </div>
