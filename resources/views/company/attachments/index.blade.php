...
<x-table id="{{ $activePage ?? '' }}-attachments" ajaxUrl="{{ routeCheck('company.attachments.index') }}?typeId={{ $entityId ?? '' }}&type={{ $type ?? '' }}">
    <thead>
        <tr>
            ...
            <th class="align-middle" data-sortable="true" data-field="user_name"> @lang('labels.user_name')</th>
            <th class="align-middle" data-sortable="true" data-field="subject"> @lang('labels.subject')</th>
