                ...
                <form class="validationForm editForm" novalidate method="POST"
                  ...
                  <div class="tab-one">
                        <div class="form-group row">
                            <label for="task_name" class="col-sm-3 col-form-label requiredAsterisk">Task Name</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="start_time" class="col-sm-3 col-form-label requiredAsterisk">Start Time</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="us_time_zone" class="col-sm-3 col-form-label requiredAsterisk">US Time Zone</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="how_often" class="col-sm-3 col-form-label requiredAsterisk">How Often</label>
                            <div class="col-sm-9">
