                                ...
                                <thead>
                                    <tr>
                                        <th class="align-middle" data-sortable="false" data-width="170"
                                            data-field="created_at">@lang('labels.account')</th>
                                        <th class="align-middle" data-sortable="false" data-width="170"
                                            data-field="updated_at">@lang('labels.agency')</th>
                                        <th class="align-middle" data-sortable="false" data-width="660"
                                            data-field="name">@lang('labels.state') </th>
                                        <th class="align-middle" data-sortable="false" data-width="100"
                                            data-field="account_type">@lang('labels.total_interest')</th>

                                        <th class="align-middle" data-sortable="false" data-width="100"
                                            data-field="account_type"> @lang('labels.earned_interest')</th>
                                        <th class="align-middle" data-sortable="false" data-width="100"
                                            data-field="account_active">@lang('labels.earned_this_period')</th>
                                        <th class="align-middle" data-sortable="false" data-width="660"
                                            data-field="name">@lang('labels.unearned_interest')</th>
                                        <th class="align-middle" data-sortable="false" data-width="660"
                                            data-field="name">@lang('labels.total_written_off')</th>
                                        <th class="align-middle" data-sortable="false" data-width="660"
                                            data-field="name">@lang('labels.total_written_off_this_period')</th>
                                    </tr>
                                </thead>
                            </x-bootstrap-table>
                        </div>
