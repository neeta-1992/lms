    ...
    <div class="">
        <div class="paymenttab d-none" data-tab="ach">
            <div class="text-center">
                <h4 class="modelTitle mb-4">ACH Information</h4>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label class="requiredAsterisk form-label labelText">Account Type</label>
                        <x-select :options="[
                        '' => 'Selct Account Type',
        ...
        <div class="paymenttab d-none" data-tab="credit_card">
            <div class="text-center">
                <h4 class="modelTitle mb-4 ">Credit Card Information</h4>
            </div>

            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="requiredAsterisk form-label labelText">Cardholder Name(Full Name)</label>
                    ...
                    <div class="form-group">
                     <label class="d-none requiredAsterisk labelText">Billing Address State</label>
                        <x-select :options="stateDropDown(['keyType' => 'state'])"
                            class="ui dropdown required" placeholder="Select option" name="mailing_state"  selected="{{ $data['mailing_state'] ?? '' }}" />
...
<div class="col-sm-6">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <x-jet-input type="text" name="cvv" class="digitLimit required cardCVV" data-limit="4"
                            maxlenght="4" value="{{ $data['cvv'] ?? '' }}" />
                    </div>
                </div>
            </div>
