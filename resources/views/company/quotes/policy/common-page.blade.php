@php
$quoteSettings = App\Helpers\AllDataBaseUpdate::quoteSetting();
	$payment_type = '';
	$policy_term = '';
...
@endphp
    ...
    <div class="row form-group">
        ...
        <div class="col-sm-9">
            <x-semantic-dropdown placeholder="Search Insurance Company" class="insurance_companyDropdown">
                <input type="hidden" name="insurance_company" @change="insurance_company = $el.value;entityId =$el.value" required>
            </x-semantic-dropdown>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <x-jet-input type="text" class="singleDatePicker" name="inception_date"  required value="{{ $data->inception_date ??  date('m/d/Y') }}" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="row">
                <div class="col-sm-4">
                    <x-select :options="$coverage_types ?? []" class="ui dropdown input-sm w-100" id="coverage_type"   name="coverage_type" data-selected="{{ $data->coverage_type ?? '' }}" />
                </div>
                <div class="col-sm-8">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <x-select :options="policyTermDropDown() ?? []" required class="ui dropdown input-sm w-100" id="policy_term" name="policy_term" selected="{{ $data->coverage_type ?? '' }}" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="row">
                <div class="col-sm-4">
                    <x-jet-input class="amount" type="text" name="pure_premium"  required value="{{ $data->pure_premium ?? '' }}"  />
                </div>
                <div class="col-sm-8">
                    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <x-select  :options="(policyTermsOption() ?? [])" class="ui dropdown input-sm w-100" required name="cancel_terms" selected="{{ $data->cancel_terms ?? '' }}" />
                ...
                <div class="col-sm-8">
                    <div class="form-group row">
                        <label for="policy_fee" class="col-sm-5 col-form-label"> @lang('labels.policy_fee')
                            ($)</label>
                        <div class="col-sm-7">
                            <x-jet-input class="amount" type="text" name="policy_fee" id="policy_fee" value="{{ $data->policy_fee ?? '' }}"  />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="row">
                <div class="col-sm-4">
                    {{ !empty($quoteSettings->short_rate) ? 'required' : null}}
                    <x-input-radio inline label="{{ __('labels.yes') }}" id="short_rate_yes" name="short_rate"  value="yes" :required="($quoteSettings->short_rate ? 'required' : '')" checked="{{ $data?->short_rate ?? '' }}" />
                    <x-input-radio inline label="{{ __('labels.no') }}" id="short_rate_no" name="short_rate"  value="no"  :required="($quoteSettings->short_rate ? 'required' : '')"  checked="{{  $data?->short_rate ?? ''  }}" />
                </div>
                <div class="col-sm-8">
                    <div class="form-group row">
                        <label for="taxes_and_stamp_fees" class="col-sm-5 col-form-label">@lang('labels.taxes_stamp_fees')
                            ($)</label>
                        <div class="col-sm-7">
                            <x-jet-input class="amount" type="text" name="taxes_and_stamp_fees" value="{{ $data->taxes_and_stamp_fees ?? '' }}"  />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="row">
                <div class="col-sm-4">
                    <x-input-radio inline label="{{ __('labels.yes') }}" id="auditable_yes" name="auditable"  value="yes" :required="($quoteSettings->auditable ? 'required' : '')" checked="{{ $data?->auditable ?? '' }}"  />
                    <x-input-radio inline label="{{ __('labels.no') }}" id="auditable_yes" name="auditable"  value="no" :required="($quoteSettings->auditable ? 'required' : '')" checked="{{ $data?->auditable ?? '' }}"  />
                </div>
                <div class="col-sm-8">
                    <div class="form-group row">
                        <label for="broker_fee" class="col-sm-5 col-form-label"> @lang('labels.broker_fee')
                            ($)</label>
                        <div class="col-sm-7">
                            <x-jet-input class="amount" type="text" name="broker_fee" value="{{ $data->broker_fee ?? '' }}"  />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="row">
                <div class="col-sm-4">
                    <x-input-radio inline label="{{ __('labels.yes') }}" id="PUC_Filings_yes" name="puc_filings"  value="yes"  :required="($quoteSettings->puc_filings ? 'required' : '')"  checked="{{ $data?->puc_filings ?? '' }}" />
                    <x-input-radio inline label="{{ __('labels.no') }}" id="PUC_Filings_no" name="puc_filings"  value="no"  :required="($quoteSettings->puc_filings ? 'required' : '')"  checked="{{ $data?->puc_filings ?? '' }}" />
                ...
                <div class="col-sm-8">
                    <div class="form-group row">
                        <label for="inspection_fee" class="col-sm-5 col-form-label"> @lang('labels.inspection_fee')
                            ($)</label>
                        <div class="col-sm-7">
                            <x-jet-input class="amount" type="text" name="inspection_fee" value="{{ $data->inspection_fee ?? '' }}"  />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <textarea name="notes" id="notes" cols="30" class="form-control dark" rows="3">{{ $data->notes ?? '' }}</textarea>
        </div>
    </div>
