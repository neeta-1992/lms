<x-app-layout>
    <x-jet-form-section :buttonGroup="['other' => [['text' => __('labels.exit'), 'url' => routeCheck($route . 'index')]]]" class="validationForm" novalidate action="{{ routeCheck($route.'store') }}" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" name='comp_domain_name' class="form-control input-sm username" id="comp_domain_name"
                    placeholder="" oninput="this.value = this.value.toLowerCase()" required>
            </div>
        </div>
		<div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="url" class="form-control input-sm" id="privacy_page_url" placeholder="www.domain.com/..."
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="comp_nav_text_color_hex" class="form-control input-sm" id="hex"
                            placeholder="">
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input type="text" class="form-control input-sm zip_mask" maxlength="5" id="payment_coupons_zip"
                            name="payment_coupons_zip" placeholder="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="email" class="form-control input-sm" name="comp_contact_email" id="comp_contact_email"
                    placeholder="" required>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="zinput zradio zradio-sm zinput-inline p-0 form-group ">
                    <input id="date_format_f_j_y" name="date_format" type="radio" required class="form-check-input"
                        value="F j, Y">
                ...
                <div class="zinput zradio zradio-sm zinput-inline p-0 form-group ">
                    <input id="date_format_custome" name="date_format" type="radio" required class="form-check-input"
                        value="custom">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                <div class="zinput zradio zradio-sm zinput-inline p-0">
                    <input id="time_format_custom" name="time_format" type="radio" required class="form-check-input"
                        value="Custom">
                    <label for="time_format_custom" class="form-check-label ml-1">@lang("labels.custom")<input type="text"
