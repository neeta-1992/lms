<x-app-layout>
    ...
    @endphp
    @endif
    <x-jet-form-section :buttonGroup="['logs', 'other' => [( $buttonArr ?? null),['text' => __('labels.cancel'), 'url' => routeCheck($route . 'index') ]]]" class="validationForm editForm" novalidate action="{{ routeCheck($route . 'update', $id) }}" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                <input type="text" name="agency_name" class="form-control input-sm" id="agency_name" placeholder="" required>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">
                        <div class="row">
                            <label for="comp_nav_back_color_rbg" class="col-sm-6 col-form-label">@lang('labels.rgb')</label>
                            <div class="col-sm-6">
        ...
        <div class="row">
            <label for="comp_nav_text_color_hex" class="col-sm-3 col-form-label">
                @lang('labels.navigation_text_color')</label>
            <div class="col-sm-9">
                <div class="form-group row">
        ...
        <div class="row">
            ...
            <div class="zinput zradio zradio-sm zinput-inline p-0 form-group ">
                <input id="date_format_d_m_y" name="date_format" type="radio" required class="form-check-input" value="d/m/Y">
            ...
            <div class="zinput zradio zradio-sm zinput-inline p-0 form-group ">
                ...
                <label for="date_format_custome" class="form-check-label">@lang('labels.custom')<input type="text" class="form-control w-25 d-inline dateformatvalue input-sm" name="date_format_value" value="{{ $data['date_format_value'] ?? '' }}"></label>
            </div>
        </div>
        </div>
        <!-- div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                <div class="zinput zradio zradio-sm zinput-inline p-0">
                    ...
                    <label for="time_format_custom" class="form-check-label ml-1">@lang('labels.custom')<input type="text" class="form-control w-25 d-inline timeformatvalue input-sm" name="time_format_value" value="{{ $data['time_format_value'] ?? '' }}"></label>
                </div>
            </div>
        </div>
        <div class="form-group row">
        ...
        <div class="row">
            ...
            <div class="col-sm-9">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row form-group">
                            <label for="administrator_email_outgoing_server" class="col-sm-12 col-form-label">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="zinput zradio  zradio-sm   zinput-inline  p-0">
                                        ...
                                        <label for="quote_activation_authentication_no" class="form-check-label">@lang('labels.no')No</label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
        ...
        <div class="form-group row">
            <label for="rightfax_server_email" class="col-sm-3 col-form-label ">@lang('labels.server_email_address')</label>
            <div class="col-sm-9">
                <input type="text" name="server_email" class="form-control input-sm" id="server_email" placeholder="">
            </div>
        </div>
        <div class="form-group row">
            <label for="fax_server_domain_name" class="col-sm-3 col-form-label ">
                @lang('labels.fax_server_domain_name')</label>
            <div class="col-sm-9">
