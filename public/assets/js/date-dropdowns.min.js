    ...
    $.extend(Plugin.prototype, {
        ...
        bindChangeEvent: function () {
            ...
            objectRefs.pluginWrapper.on('change', 'select', function () {
				...
				if (day) {
				  for (var i = 0; i < $daySelect[0].children.length; i++) {
					if ($daySelect[0].children[i].value == day) {
					  $daySelect.val(day);
					}
				  }
				}
				if (month) {
				  for (var i = 0; i < $monthSelect[0].children.length; i++) {
					if ($monthSelect[0].children[i].value == month) {
        ...
        buildBaseDropdown: function (type) {
            ...
            return $('<select></select>', {
                class: classString + " form-control input-sm",
