...
class QuoteNote extends Model
{
    ...
    protected $fillable = ['user_id','parent_id','subject','description','files','view_status','current_status','type','show_status','qId','vId'];
    protected $encryptable = ['subject','notes','priority','files'];
