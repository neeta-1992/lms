...
{
    private $viwePath   = "admin.user-guide.";
    public  $pageTitle  = "User Guides";
    public  $activePage = "user-guide";
    public  $route      = "admin.user-guide.";
    public function __construct(UserGuides $model){
       $this->model =  $model;
