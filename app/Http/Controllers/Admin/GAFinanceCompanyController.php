...
class GAFinanceCompanyController extends Controller
{
    private $viwePath   = "admin.gacompany.";
    private $route      = "admin.ga-finance-company.";
    public  $pageTitle  = "GA Finance Company";
...
@AjaxGet Data List
    */
    private function viewList(array $request = null){
        ...
        $sqlData         = $this->model::getData(['type'=>'1'])->with("user");
