...
{
    private $viwePath  = "admin.notice-templates.";
    public  $pageTitle = " Notice Template";
    public  $activePage = "notice-templates";
    public  $route      = "admin.notice-templates.";
    ...
    */
    private function viewList(array $request = null){
     ...
     public function css(Request $request){
        ...
        return view($this->viwePath."css",['route'=>$this->route,'data'=>$data,'title'=>$this->pageTitle,'activePageName'=>$activePage]);
    }
