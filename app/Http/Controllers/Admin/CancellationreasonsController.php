...
{
    private $viwePath   = "admin.cancellation-reasons.";
    public  $pageTitle  = "Cancellation Reason";
    public  $activePage = "cancellation-reasons";
    public  $route      = "admin.cancellation-reasons.";
    public function __construct(CancellationReasons $model){
       $this->model =  $model;
    }
    /**
    ...
    {
        $data = $this->model::getData(['id'=>$id])->firstOrFail()?->toArray();

        return view($this->viwePath."edit",['route'=>$this->route,'data'=>$data,'id'=>$id,'activePage'=>$this->activePage]);
    }
