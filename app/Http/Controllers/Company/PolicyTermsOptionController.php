...
class PolicyTermsOptionController extends Controller
{
    private $viwePath = "company.policy-cancel-terms-options.";
    public $pageTitle = "Policy Cancel Terms Option";
    public $activePage = "policy-cancel-terms-options";
    public $route     = "company.policy-cancel-terms-options.";
    public function __construct(PolicyTermsOption $model){
       $this->model =  $model;
    }
    /**
