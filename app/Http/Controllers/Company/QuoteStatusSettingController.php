...
class QuoteStatusSettingController extends Controller
{
    private $viwePath   = "company.quote-status-settings.";
    public $pageTitle   = "Quote Status Setting";
    public $activePage  = "quote-status-settings";
    public $route       = "company.quote-status-settings.";
    public function __construct(QuoteStatusSetting $model){
       $this->model =  $model;
    }
    /**
